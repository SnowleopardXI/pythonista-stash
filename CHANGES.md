...
* Command Scripts
    ...
    * Changed scripts
        - `pcsm.py` - Removed. The scope of the design has been broadened to
          ...
          time, [psiclient](https://github.com/SnowleopardXI/psiclient) is a
...
* Command Scripts
    ...
    * Changed scripts
        - `pcsm.py` - `scsm` is renamed to **`pcsm`** (Pythonista Command
          ...
          specific. The [Index
          repo](https://github.com/SnowleopardXI/Pythonista-Command-Script-Index) is
    ...
    * New scripts
        ...
        - **`scsm.py`** - StaSh Command Script Manager (initial attempt to build
          ...
          *install*, *remove* and *info*)
            ...
            * Check out the [Index
              repo](https://github.com/SnowleopardXI/stash-command-script-index) for
